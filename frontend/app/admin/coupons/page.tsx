      ...
      <div className="max-w-4xl mx-auto px-2 sm:px-4 py-6 sm:py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-zinc-400">Manage promo codes</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-zinc-900 border-2 border-dashed border-gray-300 dark:border-zinc-800 rounded-2xl p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-800 dark:text-zinc-400 mb-2">No Coupons</h3>
            <p className="text-gray-600 dark:text-zinc-400">Create your first promo code.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-zinc-950 border-b border-gray-200 dark:border-zinc-800">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-zinc-400">Discount</th>
              ...
              <tbody>
                {coupons.map(c => (
                  <tr key={c.id} className="border-b border-gray-100 dark:border-zinc-800/50 even:bg-gray-50/50 even:dark:bg-zinc-950/30 hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                    ...
                    <td className="px-4 py-3 text-gray-800 dark:text-zinc-400">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-zinc-400 mb-1">Discount Type</label>
                    <select
                      value={form.discount_type}
                      onChange={e => setForm({ ...form, discount_type: e.target.value as 'amount' | 'percent' })}
                      className="w-full px-3 py-2 border border-gray-200 dark:border-zinc-800 rounded-lg text-sm text-gray-900 dark:text-zinc-100 bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:outline-none transition-colors duration-200"
                    >
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-zinc-400 mb-1">Value</label>
                    <input
                      type="number"
                      step="0.01"
                      min="0"
