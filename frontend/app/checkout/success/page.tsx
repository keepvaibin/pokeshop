  ...
  return (
    <div className="bg-gray-50 dark:bg-zinc-950 min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 shadow-sm p-10">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 rounded-xl p-5 mb-8 text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/"
              className="flex-1 inline-flex items-center justify-center gap-2 border border-gray-300 dark:border-zinc-800 text-gray-700 dark:text-zinc-400 font-semibold py-3 px-6 rounded-xl hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
            >
