        ...
        <div className="space-y-8">
          ...
          <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Scheduled Campus Pickup</h2>
            </div>
          ...
          <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">ASAP Pickup</h2>
            </div>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
              Off-campus and downtown pickups can also be arranged when a scheduled slot isn&apos;t convenient.
              Select the <strong className="text-gray-800 dark:text-gray-200">&ldquo;ASAP Pickup&rdquo;</strong> option
