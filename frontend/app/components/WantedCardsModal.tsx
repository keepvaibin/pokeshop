        ...
        <div className="px-5 pt-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 text-sm">No wanted cards found</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {filtered.map((card) => (
                <button
                  ...
                  className="flex items-center gap-3 p-3 border border-gray-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 transition-all text-left group"
                >
                  {card.images?.[0]?.url ? (
                    <FallbackImage
                      ...
                      fallbackClassName="w-14 h-14 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400"
                      fallbackSize={20}
                    />
                  ) : (
