                  ...
                  <div className="px-6 py-4">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <p className="text-gray-900 font-medium">{order.item_title || `Item #${order.item}`}</p>
                      </div>
                      <div>
                      ...
                      {order.trade_card_name && (
                        <div>
                          ...
                          <p className="text-gray-900 font-medium">{order.trade_card_name} (${order.trade_card_value})</p>
                        </div>
                      )}
                      {order.preferred_pickup_time && (order.delivery_method === 'asap' || order.recurring_timeslot || order.pickup_timeslot) && (
                        <div>
                          ...
                          <p className="text-gray-900 font-medium">{order.preferred_pickup_time}</p>
                        </div>
                      )}
                    </div>
