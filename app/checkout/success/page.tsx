  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-green-100 mb-6">
            <CheckCircle className="w-10 h-10 text-green-600" />
          </div>

          <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100 mb-3">Order Confirmed! <PartyPopper className="inline w-8 h-8 text-yellow-500" /></h1>
