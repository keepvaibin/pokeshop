    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10">
          ...
          <h1 className="text-3xl font-black text-gray-900 mb-3">Order Confirmed! <PartyPopper className="inline w-8 h-8 text-yellow-500" /></h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/"
              className="flex-1 inline-flex items-center justify-center gap-2 border border-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:bg-gray-50 transition-colors"
            >
