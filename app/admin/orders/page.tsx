  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Filters */}
        <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6 shadow-sm flex flex-wrap gap-3 items-end">
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((o) => (
                    <tr key={o.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-900">{o.item_title}</td>
                      ...
                      <td className="py-3 px-4">
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${statusColor[o.status] || 'bg-gray-100 text-gray-800'}`}>
                          {o.status.replace('_', ' ')}
                        </span>
                      </td>
                    </tr>
