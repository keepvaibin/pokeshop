  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100 mb-1">Order History</h1>
        <p className="text-gray-600 mb-6">All orders across all statuses</p>
        ...
        {/* Filters */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4 mb-6 shadow-sm flex flex-wrap gap-3 items-end">
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((o) => (
                    <tr key={o.id} className="border-b border-gray-100 hover:bg-gray-50 dark:bg-gray-950">
                      ...
                      <td className="py-3 px-4">
                        <p className="text-gray-900 dark:text-gray-100 font-medium">{o.user_email}</p>
                        <p className="text-xs text-gray-500">{o.discord_handle}</p>
                      </td>
                      <td className="py-3 px-4 text-gray-900 dark:text-gray-100">{o.item_title}</td>
                      ...
                      <td className="py-3 px-4">
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${statusColor[o.status] || 'bg-gray-100 dark:bg-gray-800 text-gray-800'}`}>
                          {o.status.replace('_', ' ')}
                        </span>
                      </td>
                    </tr>
