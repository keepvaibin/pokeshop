  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-black text-gray-900 dark:text-gray-100 flex items-center gap-3 mb-2">
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex-shrink-0">
                      {item.image_path ? (
                        <FallbackImage
                          src={item.image_path} 
                          alt={item.title} 
                          className="w-20 h-20 object-cover rounded-lg bg-gray-100 dark:bg-gray-800"
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sticky top-20">
