                    ...
                    <div className="flex-shrink-0">
                      {item.image_path ? (
                        <FallbackImage
                          src={item.image_path} 
                          alt={item.title} 
                          className="w-20 h-20 object-cover rounded-lg bg-gray-100 dark:bg-zinc-800"
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-lg p-6 sticky top-20">
                ...
                <div className="py-5 space-y-3">
                  ...
                  <Link 
                    href="/" 
                    className="w-full block text-center py-3 px-6 rounded-lg border-2 border-gray-300 dark:border-zinc-600 text-gray-700 font-semibold hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
                  >
                    Continue Shopping
                  </Link>
                </div>

                <div className="text-xs text-gray-500 text-center pt-4 border-t border-gray-200 dark:border-zinc-700">
