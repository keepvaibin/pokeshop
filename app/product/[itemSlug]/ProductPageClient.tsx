      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex flex-col gap-10 py-4 lg:flex-row">
          ...
          <div className="w-full min-w-0 lg:w-1/2">
            ...
            {(item.tcg_supertype || item.tcg_type || item.tcg_stage || item.tcg_hp || item.tcg_artist) && (
            ...
            <RichText
              ...
              className="text-pkmn-gray-dark leading-relaxed mb-6 min-w-0 word-wrap [&>ul]:list-disc [&>ul]:pl-4 [&>ol]:list-decimal [&>ol]:pl-4 [&>p]:mb-1 [&_strong]:font-semibold [&_em]:italic [&_table]:max-w-full"
            />
            </div>
