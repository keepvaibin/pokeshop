          ...
          {mode === 'email_login' && (
            <form onSubmit={handleEmailLogin} className="space-y-3">
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              />
              <input
                type="password"
                value={emailPassword}
